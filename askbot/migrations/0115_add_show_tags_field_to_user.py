...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model show_tags fields to the model auth_user
        try:
            db.add_column(u'auth_user', 'show_tags', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True))
        except:
            pass
    ...
    def backwards(self, orm):
        ...
        # Deleting show_tags fields
        db.delete_column(u'auth_user', 'show_tags')
