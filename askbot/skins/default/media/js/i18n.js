...
var i18nRu = {
    ...
    'Are you sure you want to remove your {provider} login?': 'oeuaou',
    'bold': 'жирный', 
    ...
    'Change your {provider} password': 'Change your {provider} password',
    'click to close': 'нажмите, что бы закрыть', 
    'Create a password for {provider}': 'Create a password for {provider}',
    'Create password': 'Create password',
    'Create a password-protected account': 'Create a password-protected account',
    'comments': 'комментарии', 
    'community karma points': 'репутация сообщества', 
    'confirm abandon comment': 'confirm abandon comment',
    'Connect your {provider_name} account to {site}': 'Connect your {provider_name} account to {site}',
    ...
    'content minchars': 'не допускается содержание < {0}', 
    ...
    'Please add one or more login methods.': 'Please add one or more login methods.',
    'please confirm offensive': 'сообщить о спаме',
    'please enter title': 'пожалуйста, введите заголовок',
    'Please enter your {token_name}, then proceed': 'Please enter your {token_name}, then proceed',
    'Please select at least one item': 'Please select at least one item',
    'enter more characters': 'enter {0} more characters',
    ...
    'quote': 'цитата',
    'redo': 'повторить',
    'see questions tagged \'{tag}\'': 'see questions tagged \'{tag}\'',
    'Show/change current login methods': 'Show/change current login methods',
    'tablimits info': 'допускается применение не более 5 тегов',
    'tags cannot be empty': 'введите теги',
    'title minchars': 'заголовок < {0}',
